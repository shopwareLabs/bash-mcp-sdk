#!/bin/bash
# Setup BATS (Bash Automated Testing System) for the SDK test suites
# ==================================================================
...
echo "  ${BATS_DIR}/bats-core/bin/bats -r tests/"
echo ""
echo "Or run a single suite:"
echo "  ${BATS_DIR}/bats-core/bin/bats tests/mcp_argument_validation.bats"
